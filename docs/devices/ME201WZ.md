...
This is what a user has observed after installing such own device (with the help of Sigalou's documentation (https://www.sigalou-domotique.fr/je-teste-le-capteur-de-niveau-zigbee-par-ultrasons-me201wz-de-chez-moray).
...
Example:
The sensor is installed at 1.70m from bottom of tank. Max water level is 1.65m. Settings are as follow:
...
The liquid state will be "high" above 1.65m (1.7x0.97) preventing the filling pump to overflow the tank.

The water level is then manually measured as 1.42m, the sensor reports 1.42m, 86% (1.65*.86=1.419, rounded to 1.42), and liquid state is "normal"
